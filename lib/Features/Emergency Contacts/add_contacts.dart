...
import 'package:fortress/Features/User/Screens/bottom_nav.dart';
...
class _add_contactState extends State<add_contact> {
  ...
  Future<void> _loadContacts() async {
    ...
    setState(() {
      ...
      contact1controller.text = _contact1;
      contact2controller.text = _contact2;
      contact3controller.text = _contact3;
      contact4controller.text = _contact4;
      contact5controller.text = _contact5;
    });
  }
