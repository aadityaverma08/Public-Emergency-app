              ...
              child: ListTile(
                ...
                onTap: () async {
                  ...
                  if (Platform.isAndroid) {
                    url =
                        "https://www.google.com/maps/search/?api=1&query=fire+station";
              ...
              child: ListTile(
                  ...
                  onTap: () async {
                    if (await Permission.phone.request().isGranted) {
                      ...
                      Get.snackbar("Permission Denied", "Please grant phone permission to call the fire station directly.");
                    }
                  }),
            ),
            Card(
